 ...
 * ([TaskWidget.LIST_FILTER_KEY])をウィジェットインスタンスごとに選択させ、確定すると
...
class TaskWidgetConfigureActivity : ComponentActivity() {
        ...
        setContent {
            OboetotteTheme {
                ...
                AlertDialog(
                    ...
                    confirmButton = {
                        TextButton(onClick = { confirmAndFinish(selectedBackground, selectedListFilter) }) {
                            Text("追加")
                        }
                    },
                    dismissButton = {
    ...
    private fun confirmAndFinish(background: WidgetBackground, listFilter: String) {
